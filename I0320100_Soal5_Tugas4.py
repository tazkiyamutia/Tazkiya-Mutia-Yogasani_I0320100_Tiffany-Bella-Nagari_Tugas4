...
str = s[:20]
print("panjang dari s = %d" % len(str)) 

# huruf pertama ‘a’ harusnya di index no 8 
str2 = s[5::]
print("Kemunculan pertama a = %d" % str2.index("a")) 

# jumlah huruf a harusnya 2 
str2 = str2 * 2
print("a muncul sebanyak %d kali" % str2.count("a")) 
...
if s.endswith("be?"):
    print("String diakhiri dengan 'be?'. Good!") 
